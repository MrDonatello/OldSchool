...
public class TestVacancyService {
    ...
    public void testRemoveVacancyBadJobTitle() {
        assertEquals("null", server.vacancyService.removeVacancy(gson.toJson(new Vacancy("Bad title", 40000, null, tokenEmployerString, true))));
    }
    ...
    public void testAddVacancyBadToken() {
        assertEquals("null", server.vacancyService.addVacancy(gson.toJson(new Vacancy("Java", 40000, requirementsHashMap, "Bad token", true))));
    }
    ...
    public void testActivateDeactivateVacancyBadJobTitle() {
        assertEquals("null", server.vacancyService.activateDeactivateVacancy(gson.toJson(new VacancyDtoRequest("Bad title", 30000, tokenEmployerString, false))));
    }
