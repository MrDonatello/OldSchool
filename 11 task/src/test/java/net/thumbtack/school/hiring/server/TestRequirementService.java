...
public class TestRequirementService {
    ...
    public void testAddRequirementNullNameRequirement() {
        assertEquals("{\"error\":\"requirement data or vacancy data is not found\"}", server.requirementService.addRequirement(gson.toJson(new RequirementDtoRequest("JAVA", 30000, tokenEmployerString, null, 5, true))));
    }
    ...
    @Test
    public void testEditRequirementLevelBadRequirement() {
    ...
    public void testEditRequirementLevelBadJobTile() {
        assertEquals("{\"error\":\"requirement data or vacancy data is not found\"}", server.requirementService.editRequirementLevel(gson.toJson(new RequirementDtoRequest("BadTitle", 30000, tokenEmployerString, "язык JAVA", 5))));
    }
